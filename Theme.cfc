...
component{
	// Layout Variables
    this.name       	= "STAND BLOG";
	this.description 	= "Stand Blog HTML CSS Template is ready to serve as your CMS theme for your business website";
	this.version		= "1.0.0";
	...
	this.settings = [
		...
		{ name="linkedinUrl", 	group="Social Share Options", defaultValue="", type="text",	label="linkedin share url", 	required="false" },
		{ name="behanceUrl", 	group="Social Share Options", defaultValue="", type="text",	label="behance share url", 	required="false" },
